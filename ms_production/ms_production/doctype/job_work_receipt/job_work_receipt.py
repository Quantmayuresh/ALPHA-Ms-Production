...
# ======================================================================================= INWORD ===============================================================================
	@frappe.whitelist()
	def set_naming_data(self):
		item_list = []
		for i in self.get("items"):
			if i.item_name:
				item_list.append(str(i.item_name))

		self.naming_data = str(item_list)
	...
	def set_data_in_items(self):
		if not self.is_return:
			...
			if order_type and order_no:
				...
				item_data = frappe.get_all(doctype , filters = {'parent' : order_no} , fields = ['item_code','item_name','rate'])
				for i in item_data:
					if i.item_code:
						self.append("items",
